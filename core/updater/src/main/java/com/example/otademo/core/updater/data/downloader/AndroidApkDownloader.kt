package com.example.otademo.core.updater.data.downloader
...
class AndroidApkDownloader(
    ...
    override fun download(updateInfo: UpdateInfo): Flow<DownloadState> =
        flow {
            ...
            val destinationRoot = context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)
